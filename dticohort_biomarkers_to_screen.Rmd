...
p <- ggplot(data = bio24, aes(x = Recovery, y = NFL_24)) +
  geom_violin(aes(fill = Recovery)) +
...
ggsave(filename = "Figures/NFLwithScan.pdf", 
         plot = p,
         dpi = 300,
         width = 14,
         height = 10,
...
p <- ggplot(data = bio24, aes(x = Recovery, y = GFAP_24)) +
  geom_violin(aes(fill = Recovery)) +
  geom_boxplot(aes(alpha = 0.2)) +
  scale_y_continuous(trans = "log10") +
  theme_bw() +
...
ggsave(filename = "Figures/GFAP24.pdf", 
         plot = p,
         dpi = 300,
         width = 14,
         height = 10,
...
p <- ggplot(data = bio24, aes(x = Recovery, y = S100B_24)) +
  geom_violin(aes(fill = Recovery)) +
  geom_boxplot(aes(alpha = 0.2)) +
  scale_y_continuous(trans = "log10") +
  theme_bw() +
...
ggsave(filename = "Figures/S100B24.pdf", 
         plot = p,
         dpi = 300,
         width = 14,
         height = 10,
